...
nphot = 1e7                                                                     # Number of photon "packages" RADMC will create (divides luminosity into di>max_log = 1                                                                     # Defines maximum for colorbar in logscale
...
offline_wavelength = 1305                                                       # Wavelength for continuum subtraction
