...
sizex = 600 * AU								# Size across the x direction
sizey = 600 * AU								# Size across the y direction
sizez = 600 * AU								# Size across the z direction
...
wavelength = 1301.4036558							# Wavelength of desired transition for imaging, in micrometers
